...
export function safeDateFormat(date, { dateFormat, locale }) {
    return (date && formatDate(date, Array.isArray(dateFormat) ? dateFormat[0] : dateFormat, (locale: locale))) || "";
}
...
export { getSeconds, getMinutes, getHours, getMonth, getYear, getDay, getDate, getTime };
