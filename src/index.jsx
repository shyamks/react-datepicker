...
export default class DatePicker extends React.Component {
    ...
    calcInitialState = () => {
        ...
        return {
            ...
            preventFocus: false,
            preSelection: this.props.selected ? this.props.selected : boundedPreSelection,
    ...
    handleChange = (...allArgs) => {
        ...
        const date = parseDate(event.target.value, this.props.dateFormat, this.props.locale, this.props.strictParsing);
    ...
    setSelected = (date, event, keepInput, monthSelectedIn) => {
        ...
        if (!isSameDay(this.props.selected, changedDate) || this.props.allowSameDay) {
            if (changedDate !== null) {
                ...
                if (this.props.inline && this.props.monthsShown > 1 && !this.props.inlineFocusSelectedMonth) {
    ...
    onInputKeyDown = (event) => {
        ...
        if (eventKey === "Enter") {
            event.preventDefault();
            if (this.inputOk() && this.state.lastPreSelectChange === PRESELECT_CHANGE_VIA_NAVIGATE) {
